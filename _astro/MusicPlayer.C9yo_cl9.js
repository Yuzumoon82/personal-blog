import"./disclose-version.DwdwGuwu.js";import{B as h,D as p,F as D,H as Te,J as G,K as oe,L as Me,M as L,N as Ee,O as ee,P as n,Q as r,R as l,S as Le,T as j,U as se,V as De,W as de,X as ze,Y as $,Z as Ie,_ as Ve,b as ye,c as R,d as B,et as Re,f as He,g as Be,j as U,k as S,m as be,p as qe,q as re,r as Fe,t as Q,u as he,v as H,y as xe,z as Z}from"./client.JNghZhR3.js";import{t as I}from"./Icon.C19tT9us.js";import{n as O,t as J}from"./translation.BbzpoCVV.js";import{n as le}from"./config.DrdxnPV4.js";import{t as k}from"./musicPlayerStore.sme_eaSQ.js";import{a as ue,c as Ae,i as Ke,l as Ne,n as Xe,o as je,r as We,s as Ue,t as Ye}from"./SidebarTrackInfo.BLxsCZQB.js";ze();function Oe(s){const e=s-1;return e*e*e+1}function we(s){const e=s-1;return e*e*e+1}function ge(s){const e=typeof s=="string"&&s.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return e?[parseFloat(e[1]),e[2]||"px"]:[s,"px"]}function Je(s,{delay:e=0,duration:t=400,easing:g=we,x:a=0,y:o=0,opacity:y=0}={}){const u=getComputedStyle(s),_=+u.opacity,i=u.transform==="none"?"":u.transform,c=_*(1-y),[m,v]=ge(a),[C,b]=ge(o);return{delay:e,duration:t,easing:g,css:(f,P)=>`
